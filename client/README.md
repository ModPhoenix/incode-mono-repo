...
The default Jest coverage configuration can be overriden by adding any of the following supported keys to a Jest settings in your package.json.
...
[`webpack.settings.prod.js`](../config/webpack.config.prod.js).
